...
const Modal = ({ isOpen, onClose, onConfirm, title, children, confirmText = 'Đồng ý', cancelText = 'Hủy bỏ' }) => {
    if (!isOpen) return null;

    return (
        <div className='fixed top-0 right-0 left-0 z-5 flex justify-center items-center w-full h-full bg-black/50'>
