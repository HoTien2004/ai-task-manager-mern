...
export const API_PATHS = {
    ...
    TASKS: {
        ...
        GET_ALL_TASKS: "/api/tasks", // Get all tasks (Admin: all tasks, User: assigned tasks)
        ...
        UPDATE_TODO_CHECKLIST: (taskId) => `/api/tasks/${taskId}/todo`, // Update task checklist (Admin or User)
    },
